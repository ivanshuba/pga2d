# Auto-generated geometric product function for PGA2D
...
def geometric_product(a, b):
    ...
    r[4] = a[0]*b[4]+a[1]*b[2]-a[2]*b[1]+a[3]*b[7]+a[4]*b[0]-a[5]*b[6]+a[6]*b[5]+a[7]*b[3]  # e01
    r[5] = a[0]*b[5]+a[1]*b[3]-a[2]*b[7]-a[3]*b[1]+a[4]*b[6]+a[5]*b[0]-a[6]*b[4]-a[7]*b[2]  # e02
