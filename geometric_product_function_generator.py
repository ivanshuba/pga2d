...
if __name__ == "__main__":
    try:
        function_code, basis_symbols, result_terms = generate_geometric_product_function_detailed("PGA2D-Caley.csv")
        ...
        print("CSV file not found. Please make sure 'PGA2D-Caley.csv' exists.")
